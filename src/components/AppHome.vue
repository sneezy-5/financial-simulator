    ...
    <header class="home-header">
      <div class="home-header-inner" style="display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap;">
        ...
        <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
          ...
          <div v-else>
            <button @click="emit('require-auth')" style="background: #4f46e5; color: white; border: none; font-weight: 700; font-size: 0.75rem; padding: 0.5rem 0.85rem; border-radius: 0.5rem; cursor: pointer; display: flex; align-items: center; gap: 0.35rem; box-shadow: 0 2px 4px rgba(79, 70, 229, 0.2);">
