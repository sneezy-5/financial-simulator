...
function buildViewData(employee = {}, calculs = {}, companyInfo = {}) {
    ...
    const view = {
        ...
        patronal: {
            ...
            cn_employeur: n(patronal.cnEmployeur ?? patronal.impotEmployeur),
            ce_employeur: n(patronal.ceEmployeur),
    ...
    Object.assign(view, {
        ...
        cn_employeur_patronale: n(patronal.cnEmployeur ?? patronal.impotEmployeur),
        cn_employeur_patronale_base: n(calculs.brutImposable),
        ce_employeur_patronale: n(patronal.ceEmployeur),
        ce_employeur_patronale_base: n(calculs.brutImposable),
